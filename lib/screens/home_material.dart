...
import 'package:flutter_realistic_forms/screens/models/user.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                CheckboxListTile(
                  ...
                  value: _user.passions[User.PassionTravelling],
                  onChanged: (val) =>
                    setState(() => _user.passions[User.PassionTravelling] = val!)
                ),
                Container(
                  padding: const EdgeInsets.symmetric(vertical: 16.0, horizontal: 16.0),
